...
// const socket= io.connect("https://codesangambackend.onrender.com")
...
const Friends= ()=>{
    ...
    useEffect(()=>{
      const fetchFriends= async ()=>{
        const response = await fetch('https://codesangambackend.onrender.com/api/friends', {
    ...
    useEffect(()=>{
      const fetchMessages= async ()=>{
        const response = await fetch('https://codesangambackend.onrender.com/api/messages', {
         headers: {'userid': `${userid}`}
    })
     const json= await response.json();
